  ...
  const getText = () => {
    const texts = {
      ko: {
        ...
        languagePack: {
          title: '번역기 다운로드',
          description: '번역 기능을 사용하려면 기기 내장 번역기(언어 팩) 다운로드가 필요합니다. 거절하시면 다음에 "번역하기" 버튼을 누를 때 다시 다운로드 안내가 표시됩니다. 약 50MB 저장 공간이 필요하며 Wi-Fi 연결을 권장합니다.',
          agree: '다운로드하고 계속하기',
          disagree: '나중에',
        },
      },
      vi: {
        ...
        languagePack: {
          title: 'Tải công cụ dịch',
          description: 'Để sử dụng dịch, cần tải công cụ dịch tích hợp (gói ngôn ngữ). Nếu từ chối, lần sau khi nhấn "Dịch" bạn sẽ được nhắc tải lại. Cần khoảng 50MB dung lượng và nên dùng Wi-Fi.',
      ...
      en: {
        ...
        languagePack: {
          ...
          description: 'Translation requires downloading the on-device translator (language pack). If you decline, you will be asked again when you tap "Translate". About 50MB storage required; Wi-Fi recommended.',
      ...
      ja: {
        ...
        languagePack: {
          title: '翻訳のダウンロード',
          description: '翻訳を使うには端末内蔵の翻訳（言語パック）のダウンロードが必要です。拒否すると、次に「翻訳」をタップした際に再度案内されます。約50MB必要。Wi-Fi推奨。',
          agree: 'ダウンロードして続行',
          disagree: '後で',
        },
      },
      zh: {
        ...
        languagePack: {
          title: '下载翻译器',
          description: '使用翻译需下载设备内置翻译（语言包）。若拒绝，下次点击「翻译」时会再次提示下载。约需50MB空间，建议使用Wi-Fi。',
          agree: '下载并继续',
          disagree: '稍后',
        },
      },
