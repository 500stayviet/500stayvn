...
const uiTexts: Record<SupportedLanguage, Record<UITextKey, string>> = {
  ko: {
    ...
    minRentablePeriodHint:
      '최소 임대 가능 기간(연속 7일 예약)이 부족해 고객에게 노출되지 않습니다. 임대 종료일을 늘리면 다시 광고중으로 전환될 수 있습니다.',
  ...
  vi: {
    ...
    tabAdvertPending: 'Chờ QC',
    tabAdvertSuspended: 'Tạm dừng QC',
    minRentablePeriodHint:
      'Chưa đủ 7 ngày liên tiếp để hiển thị. Gia hạn ngày kết thúc để có thể hiển thị lại.',
  ...
  en: {
    ...
    tabAdvertLive: 'Live',
    tabAdvertPending: 'Paused (slots)',
    tabAdvertSuspended: 'Suspended',
    minRentablePeriodHint:
      'Not enough consecutive bookable days for guests. Extend your availability end date to go live again.',
  ...
  ja: {
    ...
    minRentablePeriodHint:
      '連続7日以上の予約枠がなくゲストに表示されていません。終了日を延長すると再掲載できます。',
  ...
  zh: {
    ...
    tabAdvertLive: '展示中',
    tabAdvertPending: '待展示',
    tabAdvertSuspended: '已停展',
    minRentablePeriodHint:
      '连续可订天数不足，未对客人展示。延长租期结束日可恢复展示。',
