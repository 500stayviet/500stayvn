...
import MyPropertiesListSection from './MyPropertiesListSection';
import MyPropertiesDialogs from './MyPropertiesDialogs';
import type { SupportedLanguage } from '@/lib/api/translation';
import MyPropertiesHeaderSection from './MyPropertiesHeaderSection';

/** 내 매물 목록 화면 — `useMyPropertiesPageState` 와 프레젠테이션만 연결한다. */
export function MyPropertiesPageView() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center" data-testid="my-properties-content">
