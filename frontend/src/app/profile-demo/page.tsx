    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-[430px] mx-auto bg-white min-h-screen shadow-2xl">
        ...
        <div className="px-4 py-6 space-y-6">
          {/* 환영 및 개인정보 카드 - 클릭하면 /profile/edit로 이동 */}
          <motion.div
          ...
          >
              ...
              <div className="flex-1">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-700">{DEMO_USER.phone}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-white rounded-lg">
                      <MapPin className="w-4 h-4 text-blue-600" />
                    </div>
                    <span className="text-sm text-gray-700">{DEMO_USER.address}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="text-xs text-gray-500 text-right group-hover:text-blue-600 transition-colors">
              개인정보 수정
            </div>
          </motion.div>
