      ...
      <div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            placeholder="조치, owner/ref, 비고, 처리자…"
            className="w-full max-w-md rounded-md border border-slate-200 bg-white px-3 py-2 text-sm placeholder:text-slate-400"
          />
          <p className="mt-1 text-xs text-slate-500">선택한 탭 범위 안에서만 검색됩니다.</p>
        </div>

        {displayedRows.length === 0 ? (
          <p className="py-12 text-center text-sm text-slate-500">이 탭·검색에 맞는 로그가 없습니다.</p>
        ) : (
          <>
