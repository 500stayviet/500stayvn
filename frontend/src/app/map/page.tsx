    ...
    <div className="min-h-screen bg-gray-100 flex justify-center">
      ...
      <div className="w-full max-w-[430px] bg-white min-h-screen shadow-2xl flex flex-col relative overflow-y-scroll overscroll-y-auto" style={{ scrollbarGutter: 'stable' }}>
        ...
        <main className="flex-1 relative flex flex-col min-h-0 bg-white">
          ...
          {/* 주변 인기 매물: 지도 아래 고정, 3D 슬라이더 적용 */}
          <div className="flex-1 flex flex-col min-h-[360px] bg-white flex-shrink-0 w-full overflow-hidden">
            <div className="flex-shrink-0 px-4 pt-4 pb-2 sm:px-6 sm:pt-5 sm:pb-3 z-10">
            ...
            <div className="flex-1 relative w-full">
              <Property3DCardSlider
                ...
                onSelectIndex={(index) => {
                  handlePropertySelect(index, nearbyProperties[index]);
                }}
